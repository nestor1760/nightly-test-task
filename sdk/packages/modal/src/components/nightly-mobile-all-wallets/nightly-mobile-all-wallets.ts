...
export class NightlyMobileAllWallets extends LitElement {
  ...
  renderNotFoundIcon() {
    return html`
      <div class="nc_mobileAllWalletsEmptyListWrapper" style="background: ${this.darkTheme ? "#1c1a1a" : ''}">
        <img
  ...
  render() {
    return html`
      <div class="nc_mobileAllWalletsWrapper" style="background: ${this.darkTheme ? "#1c1a1a" : ''}">
